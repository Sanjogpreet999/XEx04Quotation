        ...
        <main class="container">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    ...
                    <asp:Button ID="Btn_confirm" runat="server" Text="confirm" CssClass="btn btn-primary" OnClick="Btn_confirm_Click" />
            ...
            <div class="form-group">
                <div class="col-sm-offset-1 col-sm-11">
                    ...
                    <asp:Label ID="Lbl_confirm" runat="server" Text="confirm"></asp:Label>
