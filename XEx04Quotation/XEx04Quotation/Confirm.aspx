        ...
        <main class="container">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <%-- buttons go here --%>
                    <asp:Button ID="Btn_sendQuotation" runat="server" Text="Send Quotation" 
                        CssClass="btn btn-primary" OnClick="Btn_sendQuotation_Click"/>
                    <asp:Button ID="Btn_return" runat="server" Text="return" CssClass="btn btn-primary" PostBackUrl="~/Default.aspx" />
